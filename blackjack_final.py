...
class Blackjack():
    def __init__(self):
        ...
        self.screen_width, self.screen_height = 810, 810
        ...
        self.screen_mid_x, self.screen_mid_y = int(self.screen_width / 2), int(self.screen_height / 2)
